...
players = [Bot("blue", algo.MCTS(duration=timedelta(seconds=3), learn = True, memory= True, e=0.8)), Bot("Red", algo.MCTS(duration=timedelta(seconds=3), learn = True, memory= True, e=0.8)) ]
n = 750
